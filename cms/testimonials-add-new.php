    ...
    <div id="page-wrapper">
      ...
      <section class="right-content-wrapper">
        ...
        <section id="main-content" class="base">
          ...
          <form id="form" class="form" action="testimonials-add-process.php" method="post" onsubmit="return valForm()" enctype="multipart/form-data">
            ...
            <input type="text" name="txtContributor" autocomplete="off" autofocus value="<?php echo displayTxt('kcontributor'); ?>">
            ...
            <textarea type="text" name="txtTestimonial" autocomplete="off" value="<?php echo displayTxt('ktestimonial'); ?>"></textarea>
